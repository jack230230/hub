...
type RepositoryManager interface {
	...
	GetAll(ctx context.Context, includeCredentials bool, p *Pagination) ([]*Repository, error)
	GetAllJSON(ctx context.Context, includeCredentials bool, p *Pagination) (*JSONQueryResult, error)
	GetByID(ctx context.Context, repositoryID string, includeCredentials bool) (*Repository, error)
	GetByKind(ctx context.Context, kind RepositoryKind, includeCredentials bool, p *Pagination) ([]*Repository, error)
	GetByKindJSON(ctx context.Context, kind RepositoryKind, includeCredentials bool, p *Pagination) (*JSONQueryResult, error)
	...
	GetOwnedByOrgJSON(ctx context.Context, orgName string, includeCredentials bool, p *Pagination) (*JSONQueryResult, error)
	GetOwnedByUserJSON(ctx context.Context, includeCredentials bool, p *Pagination) (*JSONQueryResult, error)
