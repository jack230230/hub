...
const (
	...
	getAllReposDBQ            = `select * from get_all_repositories($1::boolean, $2::int, $3::int)`
	getOrgReposDBQ            = `select * from get_org_repositories($1::uuid, $2::text, $3::boolean, $4::int, $5::int)`
	...
	getReposByKindDBQ         = `select * from get_repositories_by_kind($1::int, $2::boolean, $3::int, $4::int)`
	getUserReposDBQ           = `select * from get_user_repositories($1::uuid, $2::boolean, $3::int, $4::int)`
